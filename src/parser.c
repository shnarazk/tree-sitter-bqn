...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 183) ADVANCE(9);
      if (lookahead == 8656) ADVANCE(8);
      if (lookahead == 8900) ADVANCE(3);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_expr] = ACTIONS(7),
    [sym_nothing] = ACTIONS(7),
    [sym_symbol_s] = ACTIONS(9),
    [sym_symbol_F] = ACTIONS(9),
    [sym_symbol__m] = ACTIONS(9),
  ...
  [2] = {
    ...
    [sym_expr] = ACTIONS(13),
    [sym_nothing] = ACTIONS(13),
    [sym_symbol_s] = ACTIONS(13),
    [sym_symbol_F] = ACTIONS(13),
    [sym_symbol__m] = ACTIONS(13),
    [sym_symbol__c_] = ACTIONS(18),
    [sym_comment] = ACTIONS(3),
  },
  [3] = {
    [aux_sym_stmt_delimiter_repeat1] = STATE(2),
  ...
  [5] = {
    ...
    [aux_sym_source_file_repeat1] = STATE(5),
    [sym_expr] = ACTIONS(26),
    [sym_nothing] = ACTIONS(26),
    [sym_symbol_s] = ACTIONS(29),
    [sym_symbol_F] = ACTIONS(29),
    [sym_symbol__m] = ACTIONS(29),
    [sym_symbol__c_] = ACTIONS(32),
    [sym_comment] = ACTIONS(3),
  },
  [6] = {
    [sym_stmt] = STATE(12),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_stmt_delimiter_repeat1, 2),
  [15] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_stmt_delimiter_repeat1, 2), SHIFT_REPEAT(2),
  [18] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_stmt_delimiter_repeat1, 2),
  [20] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stmt_delimiter, 1),
  [22] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [24] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stmt_delimiter, 1),
  ...
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_export, 2),
  [51] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [53] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_symbol, 1),
};
